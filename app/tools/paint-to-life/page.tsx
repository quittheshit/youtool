    ...
    try {
      ...
      if (uploadError) {
        ...
        try {
          ...
          const response = await fetch('https://n8n.busybiz.dk/webhook-test/ad5f0a18-085b-4a0d-acf2-a6376e675835', {
            method: 'POST',
            body: formData,
    ...
    try {
      ...
      if (uploadError) {
        ...
        try {
          ...
          const webhookResponse = await fetch('https://n8n.busybiz.dk/webhook-test/ad5f0a18-085b-4a0d-acf2-a6376e675835', {
            method: 'POST',
            body: formData,
            signal: controller.signal,
          });
